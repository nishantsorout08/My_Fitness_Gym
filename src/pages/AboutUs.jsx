        ...
        <section className="max-w-7xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-lg">
                At MY FITNESS GYM, our mission is to empower individuals to
            ...
            <div>
              ...
              <p className="text-lg">
                MY FITNESS GYM was founded in 2024 with the goal of
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-lg mt-4">
                ...
                gym, meet our team, and see for yourself why MY FITNESS GYM
